...
# ==============================================================
set ::env(LD_LIBRARY_PATH) /data/Xilinx/Vitis_HLS/2022.1/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)

set ::env(LD_LIBRARY_PATH) /data/Xilinx/Vitis_HLS/2022.1/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /data/Xilinx/Vitis_HLS/2022.1/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /data/Xilinx/Vitis_HLS/2022.1/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
if {[file isfile cluster.autotvin.dat]} {
	file delete -force cluster.autotvin.dat
}

if {[file isfile cluster.autotvout.dat]} {
	file delete -force cluster.autotvout.dat
}
